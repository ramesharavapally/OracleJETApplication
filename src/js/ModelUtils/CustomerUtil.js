...
define([],
    function () {
        class CustomerUtils {
            ...
            async fetchCustomerData(path_name) {
                try {
            ...
            async updateCustomerData(userId, data, path_name) {
                try {
                    // Implement your update logic here using the PUT or PATCH method.
                    // Example:
                    const response = await fetch(`${this.apiUrl}/${path_name}/${userId}`, {
                        method: 'PUT',
                        mode: 'cors',
                        headers: {
                            'Content-Type': 'application/json',
            ...
            async deleteCustomerData(userId, path_name) {
                try {
