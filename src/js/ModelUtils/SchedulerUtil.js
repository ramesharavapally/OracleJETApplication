...
define([],
    function () {
        class SchedulerUtils {
            ...
            async updateSchedulerData(schedulerId, data, path_name) {
                try {
                    // Implement your update logic here using the PUT or PATCH method.
                    // Example:
                    const response = await fetch(`${this.apiUrl}/${path_name}/${schedulerId}`, {
                        method: 'PUT',
                        mode: 'cors',
                        headers: {
                            'Content-Type': 'application/json',
            ...
            async deleteSchedulerData(scheduleId, path_name) {
                try {
                    // Implement your delete logic here using the DELETE method.
                    // Example:
                    const response = await fetch(`${this.apiUrl}/${path_name}/${scheduleId}`, {
                        method: 'DELETE',
                        mode: 'cors',
                    });
                    if (!response.ok) {
